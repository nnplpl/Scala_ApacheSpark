object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val hello: String = "Holaa!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val smallNumber : Byte = 127;System.out.println("""smallNumber  : Byte = """ + $show(smallNumber ));$skip(147); 
  ...
  val answer = answerString.toInt;System.out.println("""answer  : Int = """ + $show(answer ));$skip(33); 
	val numPattern = """[0-9]+""".r;System.out.println("""numPattern  : scala.util.matching.Regex = """ + $show(numPattern ));$skip(18); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(309); 
  ...
  // Just write your code below here; any time you save the file it will automatically display the results!
	val pix : Float = 3.1415926f;System.out.println("""pix  : Float = """ + $show(pix ));$skip(24); 
	val piDouble = pix*pix;System.out.println("""piDouble  : Float = """ + $show(piDouble ));$skip(54); 
	println(f"The result of pi Double is $piDouble%.3f")}
}
