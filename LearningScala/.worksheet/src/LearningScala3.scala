object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(405); 
  ...
  // Then, do the same thing using a function literal instead of a separate, named function.de
def xToUpper(x: String) : String = {
x.toUpperCase
};System.out.println("""xToUpper: (x: String)String""");$skip(25); 
println(xToUpper("foo"))}
}
