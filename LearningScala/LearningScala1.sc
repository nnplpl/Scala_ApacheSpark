object LearningScala1 {
  ...
  val hello: String = "Holaa!"                    //> hello  : String = Holaa!
  println(hello)                                  //> Holaa!
  ...
  var helloThere: String = hello                  //> helloThere  : String = Holaa!
  helloThere = hello + " There!"
  println(helloThere)                             //> Holaa! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Holaa!There!
  println(immutableHelloThere)                    //> Holaa!There!
  ...
  println("Here is a mess: " + numberOne + ' ' + truth + letterA + pi + bigNumber)
                                                  //> Here is a mess: 1 truea3.141592651234567890
  ...
  // Just write your code below here; any time you save the file it will automatically display the results!
	val pix : Float = 3.1415926f              //> pix  : Float = 3.1415925
	val piDouble = pix*pix                    //> piDouble  : Float = 9.869603
	println(f"The result of pi Double is $piDouble%.3f")
                                                  //> The result of pi Double is 9.870
}